...
const Carousel = () => {
  ...
  // Fungsi untuk mengambil daftar gambar dari localStorage
  const fetchImagesFromLocalStorage = () => {
    const storedImages = JSON.parse(localStorage.getItem("Galery/GambarAman")) || [];
      ...
      <div id="Carousel">
        <Slider {...settings}>
          {images.map((imageData, index) => (
            <img
              key={index}
              src={imageData.url} // Mengambil URL gambar dari localStorage
              alt={`Image ${index}`}
