	...
	return (
		<div className="z-1 relative h-auto lg:overflow-hidden">
			...
			<div data-aos="fade-up" data-aos-duration="500" className="mt-14 md:mt-10">
				<BorderStruktur Jabatan="Wali Kelas" Nama="Nunuk Sulistiyaningrum S, S.pd" Width="250px" />
			</div>
			<div className="flex flex-col justify-center items-center">
				...
				<div className="flex relative top-[-3rem]" data-aos="fade-up" data-aos-duration="1200">
					<div className="relative left-[0.2rem]">
						<BorderStruktur Jabatan="Ketua Kelas" Nama="Jibran" Width="120px" />
					</div>
					...
					<div className="relative right-[0.2rem]">
						<BorderStruktur Jabatan="Wakil Ketua" Nama="Aya" Width="120px" />
					</div>
				</div>

				<div data-aos="fade-up" data-aos-duration="110" className="">
				...
				<div className="lg:flex">
					...
					<img
						src="LineHorizontal.svg"
						alt=""
						className="relative top-[-4.7rem] hidden lg:flex"
						data-aos="fade-up"
						data-aos-duration="600"
					/>
					...
					<img
						src="LineHorizontal.svg"
						alt=""
						className="relative top-[-4.7rem] hidden lg:flex lg:w-[4.2rem]"
						data-aos="fade-up"
						data-aos-duration="600"
					/>
				</div>
				...
				<div
					className="flex gap-[10.6rem] relative top-[-5.7rem] lg:gap-[27.4rem]"
					data-aos="fade-up"
					data-aos-duration="800">
					<img src="LineKananKiri.svg" alt="" />
					<img src="LineKananKiri.svg" alt="" />
				...
				<div
					className="flex gap-[10.6rem] relative top-[-6.8rem] lg:gap-[27.4rem]"
					data-aos="fade-up"
					data-aos-duration="1000">
					<img src="Circle.svg" alt="" />
					<img src="Circle.svg" alt="" />
				...
				<div
					...
					<div className="flex-col">
						<BorderStruktur Jabatan="Sekertaris" Nama="Addis" Width="120px" />
						<div className="py-[3%]"></div>
						<BorderStruktur Jabatan="" Nama="Yayan" Width="120px" />
					</div>

					<div className="flex-col">
						<BorderStruktur Jabatan="Bendahara" Nama="Hanun" Width="120px" />
						<div className="py-[3%]"></div>
						<BorderStruktur Jabatan="" Nama="Luthfia" Width="120px" />
					</div>
				</div>
